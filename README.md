...
<p>Greetings, digital explorer! I'm <strong>Om Kawale</strong> — where artistry meets algorithms. My journey began with a fascination for technology, evolving into a passion for creating intuitive user experiences.</p>
...
<ul>
  <li>Frontend Development: React, Next.js, TypeScript, Tailwind CSS</li>
  <li>Backend Development: Node.js, Express, MongoDB</li>
  <li>AI & Data: TensorFlow, PyTorch, Python</li>
  <li>DevOps: Docker, Git, GitHub Actions</li>
</ul>

---

<h2 id="tech-ecosystem">⚙️ Tech Ecosystem</h2>
<div align="center">
  ...
  <table>
    <tr>
      <td width="50%">
        ...
        <p><strong>Technologies:</strong> TypeScript, Next.js, TailwindCSS</p>
...
<h2 id="contribution-galaxy">📊 Contribution Galaxy</h2>
<div align="center">
